...
@section('content')
<input type="hidden" id="subCatSlug" value="{{ $slug }}">
    ...
    <div class="container">
        <div class="breadcrumb-content">
            <ul>
                ...
                <li class="active">sub-category / {{ ucfirst($slug) }}</li>
            </ul>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function(){
        // load product table
        function loadTable(){
            let slug= $('#subCatSlug').val();
            $.ajax({
                url:"{{ route('get.subCat.pro') }}",
                data:{slug,slug},
