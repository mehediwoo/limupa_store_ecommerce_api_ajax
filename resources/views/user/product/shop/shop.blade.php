...
@section('title',' Shop | Limupa Store')
@section('content')
            ...
            <div class="col-lg-3 order-2 order-lg-1">
                ...
                <div class="sidebar-categores-box mt-sm-30 mt-xs-30">
                    ...
                    <div class="category-sub-menu">
                        <ul>
                            ...
                            <li class="has-sub"><a href="{{ route('category.product',$row->slug) }}">{{ $row->title }}</a>
                                <ul>
                ...
                <div class="sidebar-categores-box mb-sm-0 mb-xs-0">
                    ...
                    <div class="category-tags">
                        <ul>
                            @if (!empty($p_assets))
                            @foreach ($p_assets as $row)
                            @foreach (explode(',',$row->p_meta_tags) as $tag)
                            <li>
                                <a href="">{{ $tag }}</a>
                            </li>
                            @endforeach
